      ...
      <div className="min-h-screen bg-[#fdfaf6] font-sans text-[#1a1a1a]">
        <div className="relative overflow-hidden">
          <motion.img
            ...
            className="pointer-events-none absolute inset-x-0 bottom-0 w-full select-none lg:bottom-auto lg:top-0 h-full lg:h-auto object-cover origin-bottom"
            aria-hidden
          />
        ...
        <section className="relative bg-gradient-to-b from-[#fdfaf6] via-[#faf5ec] to-[#f5e9d9] pt-10 pb-24 sm:pt-14 sm:pb-32 border-t border-[#1a1a1a]/5 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute top-1/4 left-[10%] w-96 h-96 bg-[#f4a261]/8 rounded-full blur-3xl pointer-events-none"
          />
          <motion.div
            animate={{ y: [0, 40, 0], scale: [1, 1.1, 1], opacity: [0.8, 1, 0.8] }}
            transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }}
            className="absolute bottom-1/4 right-[10%] w-96 h-96 bg-[#e76f51]/4 rounded-full blur-3xl pointer-events-none"
          />
